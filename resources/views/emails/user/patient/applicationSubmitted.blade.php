...
<body>
    <div class="reset-wrapper">
        ...
        <h1 class="title"><svg version="1.1" id="Capa_1" x="0px" y="0px" width="45.311px" height="45.311px" viewBox="0 0 45.311 45.311" style="enable-background:new 0 0 45.311 45.311;" xml:space="preserve">
            ...
            </svg> APPLICATION SUBMITTED</h1>
        <h3><strong>Dear {{$applicationReview->user->first_name}}, </strong></h3>
        <p>Your application to the CHF program has been submitted successfully and pending
            review. You are required to visit your doctor and the social welfare department at your selected hospital for verification.</p>


        <p><em>For further details and enquiries, communicate with your choosen hospital (Center of Excellence) for advice. You can also leave a chat for CHF support team using the chat on CHF at <a href="https://chf.emgeresources.com">https://chf.emgeresources.com</a> .</em></p>
        <p class="foot-note"></p>
        <p class="foot-note">
