...
<head>
    ...
    <title>CHF - Drug Billing Invoice</title>
    ...
    <div class="container">
        <div class='invoice_container'>
            <div class='row invoice_header'>
                <div class="col-md-6">
                    {{-- <img class="img-fluid img-responsive" src="{{asset('./logo.png')}}" alt="chf logo" /> --}}
                </div>
                <div class='col-md-6'>
            ...
            <div class='row'>
                ...
                <div class='col-md-6'>
                    ...
                    <p>Federal Secretariat Complex, Phase III</p>
            ...
            <div class='row table table-responsive-sm invoice_section'>
                ...
                @foreach($drugs as $drug_service)
                <?php
                $drug = $drug_service['drug'];
                $total += ($drug_service['quantity'] * $drug['retail_cost']); ?>
                <div class='row'>
                    <div class='col-sm-3'>
                        <p>{{$drug['prod_name']}}</p>
                    </div>
                    ...
                    <div class='col-sm-3'>
                        <p><del>N</del> {{$drug['retail_cost']}}</p>
                    </div>
                    <div class='col-sm-3'>
                        <p>{{$drug_service['quantity']}}</p>
                    </div>
        ...
        <div class='col-sm-12'>
            <small>
                <strong>
                    <em>Login to your CHF account for further details.</em>
                </strong>
            </small>
        </div>
    </div>
