...
# OUTWARD REFERRAL COMPLETED NOTIFICATION

You are receiving this email because services for a patient referral from your hospital to {{ $referral->referenceCOE->coe_name }} have been provided. Consequently, the transaction amount has been credited to the reference hospital on the CHF portal.

An email notification has been sent to the reference hospital in this regard. You are hereby advised to transfer the same amount as below to the reference hospital's CHF bank account.
